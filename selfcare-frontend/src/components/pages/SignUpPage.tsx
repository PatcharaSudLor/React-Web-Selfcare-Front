...
export default function SignUpPage({ onBack, onLogin }: SignUpPageProps) {
  ...
  return (
    ...
    <div className="min-full-screen w-full bg-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-12">
        <div className="w-full max-w-lg lg:max-w-xl space-y-8">
          ...
          {/* Title - ขยายขนาด */}
          <h1 className="text-4xl lg:text-5xl text-center text-emerald-300 mb-10">
            Get started
          </h1>
          ...
          {/* Error Message */}
          {error && (
            <div className="bg-red-50 border-2 border-red-200 text-red-600 px-5 py-3 lg:py-4 rounded-full text-sm lg:text-base text-center">
              {error}
            </div>
          )}
          ...
          <div className="flex justify-center gap-8 lg:gap-10 mt-8">
            {/* Google Button */}
            <button
