      ...
      <div className="max-w-4xl mx-auto pt-6">
        ...
        <div className="bg-white rounded-3xl shadow-sm p-8">
          ...
          <div className="mb-8">
            ...
            {/* Info Popup - แก้ไขจุดที่ปิดแท็กไม่ครบตรงนี้ */}
            {showBodyTypeInfo && (
              <div className="mb-6 p-5 text-left bg-emerald-50 rounded-2xl border-2 border-emerald-200">
                <h4 className="font-semibold text-emerald-700 text-[18px] mb-3">Body Types คืออะไร?</h4>
                <div className="space-y-3 text-[15px] text-gray-700">
                  <div>
                    <strong className="text-emerald-600">🔹 Ectomorph:</strong> รูปร่างผอม เพิ่มน้ำหนักยาก เผาผลาญอาหารเร็ว
                  </div>
                  <div>
                    <strong className="text-emerald-600">🔹 Mesomorph:</strong> รูปร่างนักกีฬา สร้างกล้ามเนื้อง่าย เผาผลาญพอดี
                  </div>
                  <div>
                    <strong className="text-emerald-600">🔹 Endomorph:</strong> รูปร่างอวบ น้ำหนักเพิ่มง่าย เผาผลาญช้า
                  </div>

                  {/* ส่วนวิธีวัดรอบข้อมือ */}
                  <div className="mt-4 pt-4 border-t border-emerald-200">
                    <h5 className="font-bold text-[16px] text-emerald-700 mb-2 flex items-center gap-1">
                      📏 วิธีเช็คแบบง่าย (วัดรอบข้อมือ)
                    </h5>
                    <p className="text-[14px] text-emerald-600 mb-2">*ใช้สายวัด วัดส่วนที่แคบที่สุดของข้อมือ</p>

                    <div className="grid grid-cols-1 gap-2">
                      <div className="grid grid-cols-[1fr_110px] border-b border-emerald-100 pb-1 text-[13px] text-gray-700">
                        <span>• ต่ำกว่า 6 นิ้ว</span>
                        <span className="font-bold text-left">Ectomorph</span>
                      </div>
                      <div className="grid grid-cols-[1fr_110px] border-b border-emerald-100 pb-1 text-[13px] text-gray-700">
                        <span>• 6 - 7 นิ้ว</span>
                        <span className="font-bold text-left">Mesomorph</span>
                      </div>
                      <div className="grid grid-cols-[1fr_110px] text-[13px] text-gray-700">
                        <span>• มากกว่า 7 นิ้วขึ้นไป</span>
                        <span className="font-bold text-left">Endomorph</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-left text-gray-500 mb-4 ml-5">เลือกเป้าหมายที่ต้องการ</p>
            <div className="flex gap-3 flex-wrap">
              <button
          ...
          <div className="mb-8">
            ...
            <input
              ...
              placeholder="ระบุโรคประจำตัวหรือข้อจำกัด (ถ้ามี)"
