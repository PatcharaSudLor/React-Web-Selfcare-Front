...
interface WorkoutScheduleProps {
  onBack: () => void;
  onSaveToSchedule?: (schedule: any[]) => void;
}

export default function WorkoutSchedule({ onBack, onSaveToSchedule }: WorkoutScheduleProps) {
  const location = useLocation()
  const navigate = useNavigate()
  const plan = location.state?.plan as WeeklyWorkoutPlan | undefined
    ...
    day: day.day,
    dayTh: day.dayTh || dayThMap[day.day],
